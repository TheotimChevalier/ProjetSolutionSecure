...
namespace ProjetSolutionSecure.Controllers
{
    public class VoituresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Poids,Title")] Voiture voiture)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Poids,Title")] Voiture voiture)
        {
            if (id != voiture.Id)
            {
                return NotFound();
